        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              {
                name: 'Sarah Mitchell',
                relation: 'Mother of Ethan, Age 11',
              ...
              {
                name: 'Priya Sharma',
                relation: 'Mother of Aarav, Age 12',
              ...
              {
                name: 'Rajesh Patel',
                relation: 'Father of Ananya, Age 10',
              ...
              {
                name: 'Meera Iyer',
                relation: 'Mother of Karthik, Age 14',
              ...
              {
                name: 'David Thompson',
                relation: 'Father of Lily, Age 13',
